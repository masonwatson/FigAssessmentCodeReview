...
namespace FigAssessmentCodeReviews.CodeReviews
{
    ...
    */
    ...
    public class ProductController : ControllerBase
    {
        ...
        // Would you mind thinning out this controller? Validation, logic, and mapping should be moved to our service!
        ...
        public async Task<IActionResult> GetProducts(string category = null, int page = 1, int pageSize = 10, decimal? minPrice = null, decimal? maxPrice = null)
        {
            ...
            // method called GetProductsAsync() that we can pass our QueryObject to? This will help us reduce the complexity of filtering logic, because we can tell the query to filter!
        ...
        // This looks like it might need the same update as lines 23-26!
        [HttpPost]
        public async Task<IActionResult> CreateProduct([FromBody] ProductCreateRequest request)
        {
            // Love the 4XX error handling! Would you mind moving the validation to the service though?
        ...
        // new generalized GetProductsAsync() mentioned in line 32 with the category as a query param
        ...
        // This is prettys similar to the comment mentioned on lines 113-114! We should be able to make the serach term a query param
